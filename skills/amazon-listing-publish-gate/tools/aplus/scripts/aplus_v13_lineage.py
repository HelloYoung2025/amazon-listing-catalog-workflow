#!/usr/bin/env python3
"""Deterministic, standalone Handoff v1.1 refreeze-lineage contract for A+."""
...
LINEAGE_RECORD_KEYS = {
    "snapshot_id", "handoff_checksum", "parent_bundle_sha256", "status",
    "successor_snapshot_id", "semantic_revision", "created_at", "superseded_at",
    "immutable_handoff", "record_checksum",
}
